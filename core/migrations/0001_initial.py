# Generated by Django 2.2.13 on 2020-06-30 19:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.CharField(choices=[('new', 'new'), ('best rated', 'best rated'), ('best seller', 'best seller')], max_length=15)),
                ('slug', models.SlugField(default='nWZnBeNVwzziTBZ4', unique=True)),
                ('description', models.TextField()),
                ('image', models.ImageField(upload_to='media_root')),
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('category', models.ManyToManyField(related_name='items', to='core.Category')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='review', to='core.Item')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['created_on'],
